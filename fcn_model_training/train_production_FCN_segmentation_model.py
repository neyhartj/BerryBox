...
proj_dir = "/project/gifvl_vaccinium/cranberryFieldImaging/berryFieldImagePipeline/trainedSegmentationModel/"
...
# Open a file
param_filename = proj_dir + current_model_name + "_normalization_param.txt"
handle = open(param_filename, "w")
