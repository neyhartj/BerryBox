...
#SBATCH --job-name="berrybox_fcn_developmental_training_testing"
...
source /project/gifvl_vaccinium/cranberryFieldImaging/virtenv_cuda113/bin/activate

# Print the GPU allocation
nvidia-smi

# Run the python script
python trainTest_BerryBox_FCNSegmentation_Developmental.py
