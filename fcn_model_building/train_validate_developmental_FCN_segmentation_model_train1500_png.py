...
proj_dir = "/project/gifvl_vaccinium/cranberryFieldImaging/berryImageSegmentation/FCN_Semantic_Segmentation_Model_Training/"
 
num_materials = len(materials)

#Various input/output directories
# IMPORTANT: END EACH DIRECTORY PATH WITH A "/"
training_image_directory = proj_dir + "/train1500_png/train/images/"
training_mask_directory = proj_dir + "/train1500_png/train/masks/"
...
model_group='fcn_berryFinder_3.1.4_dev_train1500_png/'
...
current_model_name = "fcn_berryFinder_" + ds + "_model"
...
# IMPORTANT: END EACH DIRECTORY PATH WITH A "/"
test_images = proj_dir + "/train1500_png/test/images/"
test_masks= proj_dir + "/train1500_png/test/masks/"
